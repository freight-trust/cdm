...
import {
  UnitEnum, RoundingDirectionEnum, ObligationCategoryEnum, ConfirmationStatusEnum, AffirmationStatusEnum, QuotationSideEnum, TransferSettlementEnum, TransferStatusEnum, PriceExpressionEnum, TimeUnitEnum,
  InterpolationMethodEnum, FloatingRateIndexEnum, QuotationRateTypeEnum, ValuationMethodEnum, IndexAnnexSourceEnum, InterestShortfallCapEnum, EntityTypeEnum, SettledEntityMatrixSourceEnum, BusinessCenterEnum, CategoryEnum,
  QuoteBasisEnum, InformationProviderEnum, AveragingInOutEnum, MarketDisruptionEnum, DeterminationMethodEnum, TimeTypeEnum, SettlementTypeEnum, RestructuringEnum, TriggerTimeTypeEnum, TriggerTypeEnum,
  BrokerConfirmationTypeEnum, CalculationAgentPartyEnum, RollConventionEnum, PeriodExtendedEnum, MatrixTermEnum, MatrixTypeEnum, ContractualSupplementEnum, CreditSupportAgreementTypeEnum, ContractualDefinitionsEnum, RateTreatmentEnum,
  AveragingMethodEnum, NegativeInterestRateTreatmentEnum, MasterAgreementTypeEnum, MasterConfirmationAnnexTypeEnum, MasterConfirmationTypeEnum, PayRelativeToEnum, PremiumTypeEnum, WeeklyRollConventionEnum, ResourceTypeEnum, LengthUnitEnum,
  SpreadScheduleTypeEnum, PayerReceiverEnum, AdditionalTypeEnum, AmendmentEffectiveDateEnum, RegulatoryRegimeEnum, CreditRatingAgencyEnum, ReturnTypeEnum, DeliveryAmountElectionEnum, HoldingPostedCollateralEnum, ExecutionLocationEnum,
  InterestAdjustmentPeriodicityEnum, GoverningLawEnum, LegalAgreementNameEnum, LegalAgreementPublisherEnum, MarginApproachEnum, QuantifierEnum, CreditNotationMismatchResolutionEnum, RecalculationOfValueElectionEnum, ExceptionEnum, SensitivitiesEnum,
  SimmExceptionApplicableEnum, IssuerTypeEnum, SupraNationalIssuerTypeEnum, CreditRiskEnum, EquityTypeEnum, FundProductTypeEnum, ProductTypeEnum, SecurityTypeEnum, ConcentrationLimitTypeEnum, MaturityTypeEnum,
  BondClassEnum, BondInterestEnum, BondPrincipalEnum, BondSeniorityEnum, BusinessDayConventionEnum, DayTypeEnum, PeriodEnum, CashflowTypeEnum, AssetTransferTypeEnum, CommodityReferencePriceEnum,
  ActionEnum, IntentEnum, EventTimestampQualificationEnum, WorkflowStatusEnum, CreditLimitTypeEnum, LimitLevelEnum, WarehouseIdentityEnum, PeriodTimeEnum, MortgageSectorEnum, ProductIdSourceEnum,
  TaxonomySourceEnum, PartyRoleEnum, AccountTypeEnum, NaturalPersonRoleEnum, TelephoneTypeEnum, DividendDateReferenceEnum, DividendAmountTypeEnum, DividendEntitlementEnum, DividendPeriodEnum, ShareExtraordinaryEventEnum,
  NationalizationOrInsolvencyOrDelistingEventEnum, IndexEventConsequenceEnum, StubPeriodTypeEnum, CallingPartyEnum, DayCountFractionEnum, DiscountingTypeEnum, SettlementRateOptionEnum, ResetRelativeToEnum, ClosedStateEnum, ExecutionTypeEnum,
  CompoundingMethodEnum, OptionTypeEnum, DeliveryMethodEnum, RepoDurationEnum, MarginTypeEnum, NotionalAdjustmentEnum, AssetClassEnum, QuotationStyleEnum, PositionStatusEnum
    } from './enums';
...
/**
 * A class to specify the treatment terms for the eligible collateral criteria specified.
 */
 ...
 */
export interface ConcentrationLimitCriteria {
  /**
...
export interface EligibleCurrencyInterestRate {
  actual365Currency?: FieldWithMeta<String>;
  /**
...
export interface Execution {
  ...
  partyRole?: PartyRole[];
  /**
   * The settlement terms applicable to any initial transfer of cash or securities resulting from the transaction that is not part of the product definition: e.g. option premium, swap unwind fee, security delivery vs payment.
   */
  settlementTerms?: SettlementTerms[];
  /**
...
export interface OptionSettlement extends SettlementTerms {
  ...
  /**
   * Identifier for the asset being settled.
   */
  assetIdentifier?: AssetIdentifier;
  /**
   * The direction of transfer of the settlement.
   */
  payerReceiver?: PayerReceiver;
  /**
...
export interface ProductCriteria {
   ...
   */
  collateralProductType?: ProductType[];
  /**
   * Filter based on the underlying asset denominated currency.
   */
  denominatedCurrency?: FieldWithMeta<String>[];
  /**
   * Security must be denominated in the domestic currency of the issuer.
   */
...
/**
 * The settlement terms applicable to any transfer of cash or securities, including the date, amount, payer/receiver side and type (e.g. cash vs physical, DvP etc.)
 */
